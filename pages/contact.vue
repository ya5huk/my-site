    ...
    <div class="container">
        ...
        <div class="flex flex-wrap gap-4">
            ...
            <nuxt-link to="https://www.instagram.com/ilan_yashuk/" class="btn w-36 flex items-center gap-2 rounded-lg ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" :width="iconSizePx" viewBox="0 0 16 16">
                    <path
            ...
            <nuxt-link to="mailto:ilan147963@gmail.com" class="btn w-60 flex items-center gap-2 rounded-lg ">

                <svg xmlns="http://www.w3.org/2000/svg" :width="iconSizePx" fill="currentColor" class="bi bi-mailbox"
                    viewBox="0 0 16 16">
                    <path
